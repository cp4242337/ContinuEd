...
<input type="hidden" name="addans"
	value="true">
	<?php if ($this->part !=1) { ?>
<input name="evalstep" id="evalstep" value="Previous Page" type="submit" class="cebutton" onclick="document.evalf.stepnext.value='prev'">
	<?php } ?>
<input name="evalstep" id="evalstep" value="Next Page" type="submit" class="cebutton" onclick="document.evalf.stepnext.value='next'">
	<?php } else { ?>
...
<input name="evalstep" id="evalstep" value="Previous Page" type="submit" class="cebutton" onclick="document.evalf.stepnext.value='prev'">
	<?php } ?>
<input name="evalstep" id="evalstep" value="Submit" type="submit" class="cebutton" onclick="document.evalf.stepnext.value='eval'">
