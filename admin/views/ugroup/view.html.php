...
class ContinuEdViewUGroup extends JView
{
	/**
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_CONTINUED_MANAGER_UGROUP_NEW') : JText::_('COM_CONTINUED_MANAGER_UGROUP_EDIT'), 'ugroup');
