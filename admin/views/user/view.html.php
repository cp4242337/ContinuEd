...
class ContinuEdViewUser extends JView
{
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_CONTINUED_USER_CREATING') : JText::_('COM_CONTINUED_USER_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "/administrator/components/com_continued/views/user/submitbutton.js");
		JText::script('COM_CONTINUED_USER_ERROR_UNACCEPTABLE');
	}
}
