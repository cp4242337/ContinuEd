...
class ContinuedViewUGroups extends JView
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('COM_CONTINUED_MANAGER_UGROUPS'), 'continued');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle(JText::_('COM_CONTINUED_MANAGER_UGROUPS'));
	}
}
