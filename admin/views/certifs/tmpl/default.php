...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th><?php echo JText::_( 'Provider' ); ?></th>
		</tr>
	</thead>
	<?php
	$k = 0;
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$link 		= JRoute::_( 'index.php?option=com_continued&controller=certif&task=edit&question='.$this->questionid.'&lid[]='. $row->ctmpl_id );

		?>
	<tr class="<?php echo "row$k"; ?>">
		<td><?php echo $row->ctmpl_id; ?></td>
