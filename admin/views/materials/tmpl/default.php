...
?>
<form action="<?php echo JRoute::_('index.php?option=com_continued&view=materials'); ?>" method="post" name="adminForm">
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_course" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_CONTINUED_MATERIAL_SELECT_COURSE');?></option>
