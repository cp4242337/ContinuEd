...
class ContinuEdViewCat extends JView
{
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_CONTINUED_MANAGER_CAT_NEW') : JText::_('COM_CONTINUE_MANAGER_CAT_EDIT'), 'cat');
	...
	protected function setDocument() 
	{
		...
		$document->setTitle($isNew ? JText::_('COM_CONTINUED_CAT_CREATING') : JText::_('COM_CONTINUED_CAT_EDITING'));
		$document->addScript(JURI::root() . $this->script);
		$document->addScript(JURI::root() . "/administrator/components/com_continued/views/cat/submitbutton.js");
		JText::script('COM_CONTINUED_CAT_ERROR_UNACCEPTABLE');
	}
}
